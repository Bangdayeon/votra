-- 기존 계정 중 aiPolicyText 가 비어있는 사용자에게 기본 정책을 채워 넣어요.
-- (domain/aiSpec/types.ts 의 DEFAULT_AI_POLICY_TEXT 와 동일한 내용)
UPDATE "User"
SET "aiPolicyText" = $POLICY$# AI 스펙 운영 정책
